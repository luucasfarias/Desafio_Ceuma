...
@ControllerAdvice
public class RefreshToken implements ResponseBodyAdvice<OAuth2AccessToken>{

	// Estas configs comentadas se for pra colocar em prod, por padrao ta false
	@Autowired
